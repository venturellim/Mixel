// metalLeadEngine.js — ver. 092 CLEAN
...
const LeadLegacy = {
    schedule(section, progression, instruments, params, rand, measureDur, rootNote, isMinor, scaleType, score) {
        ...
        let sectionType = isIntro ? "intro" : isPreChorus ? "prechorus" : isChorus ? "chorus" : "verse";
        ...
        if (isOutro) {
            ...
            finalRun.forEach((n, i) => {
                guitarLead.triggerAttackRelease(n, "8n", t + 0.35 + i * 0.08, 0.75);
            });
